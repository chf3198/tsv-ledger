...
class DataLoader {
  ...
  generateMockData(count = 100) {
    const mockData = [];
    const categories = ['Food & Groceries', 'Household & Personal Care', 'Electronics', 'Books', 'Clothing'];
    const items = {
      'Food & Groceries': ['Milk', 'Bread', 'Apples', 'Chicken', 'Rice'],
      'Household & Personal Care': ['Paper Towels', 'Laundry Detergent', 'Dish Soap', 'Trash Bags'],
