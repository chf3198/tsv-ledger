...
test.describe('Benefits persistence (converted)', () => {
  test('selections persist across reloads', async ({ page }) => {
    ...
    await page.waitForFunction(() => {
      try {
        const mgr = (typeof employeeBenefitsManager !== 'undefined') ? employeeBenefitsManager : (window.employeeBenefitsManager || null); return !!mgr && typeof (mgr.loadSavedSelection || mgr.loadSelection) === 'function';
      } catch (e) {
        return false;
      }
    }, { timeout: 20000 });
